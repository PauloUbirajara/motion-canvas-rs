...
fn main() {
    ...
    project.scene.add(triangle_line_group.clone());
    project.scene.add(pytagorean_theorem.clone());
    project.scene.add(text_a.clone());
    project.scene.add(text_b.clone());
    project.scene.add(text_c.clone());
