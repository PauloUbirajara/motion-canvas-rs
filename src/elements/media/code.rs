...
impl Default for CodeNode {
    fn default() -> Self {
        let font_size = crate::assets::code_tokenizer::DEFAULT_FONT_SIZE;
        let language = crate::assets::code_tokenizer::DEFAULT_LANGUAGE.to_string();
        let theme = crate::assets::code_tokenizer::DEFAULT_THEME.to_string();
        let font_family = crate::assets::code_tokenizer::DEFAULT_FONT_FAMILY.to_string();
        ...
        Self {
            ...
            opacity: Signal::new(crate::assets::code_tokenizer::DEFAULT_OPACITY),
            dim_opacity: Signal::new(crate::assets::code_tokenizer::DEFAULT_DIM_OPACITY),
            language,
            theme,
            font_family,
        }
...
impl CodeNode {
    ...
    pub fn edit(
        ...
        code: &str,
        duration: Duration,
    ) -> crate::core::animation::SignalTween<CodeValue> {
